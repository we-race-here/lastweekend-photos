...
NAME="wrh_photos"                                  # Name of the application
ROOTDIR=/opt/webapps
...
DJANGO_SETTINGS_MODULE=wrh_photos.settings.main             # which settings file should Django use
DJANGO_WSGI_MODULE=wrh_photos.wsgi                     # WSGI module name
...
export PYTHONPATH=${DJANGODIR}/wrh_photos:${PYTHONPATH}
