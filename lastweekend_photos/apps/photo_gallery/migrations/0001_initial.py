# Generated by Django 2.2 on 2019-04-30 06:24
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('low_resolution', models.ImageField(editable=False, upload_to=apps.photo_gallery.models.photo_low_resolution_file_path_func)),
                ('thumbnail', models.ImageField(editable=False, upload_to=apps.photo_gallery.models.photo_thumbnail_file_path_func)),
                ('price', models.DecimalField(blank=True, decimal_places=2, max_digits=8, null=True)),
                ('downloads', models.PositiveIntegerField(default=0)),
                ('likes', models.PositiveIntegerField(default=0)),
                ('archive_datetime', models.BooleanField(blank=True, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='tag', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='Sponsor',
        ...
        migrations.AddField(
            model_name='photo',
            name='tags',
            field=models.ManyToManyField(to='photo_gallery.Tag'),
        ),
        migrations.CreateModel(
            name='Cart',
            fields=[
