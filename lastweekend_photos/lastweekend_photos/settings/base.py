"""
Django settings for lastweekend_photos project.
...
EXTERNAL_CONFIG_PATH = '/opt/webapps/lastweekend_photos/etc/external_config.py'
...
MIDDLEWARE = [
    ...
    'lastweekend_photos.helpers.middleware.DisableCSRFMiddleware',
    'django.contrib.auth.middleware.AuthenticationMiddleware',
    'django.contrib.messages.middleware.MessageMiddleware',
    'django.middleware.clickjacking.XFrameOptionsMiddleware',
    'lastweekend_photos.helpers.middleware.InjectUiVersionInHeadersMiddleware',
    'lastweekend_photos.helpers.middleware.CustomRevisionMiddleware',
]

REST_FRAMEWORK = {
    'EXCEPTION_HANDLER': 'lastweekend_photos.helpers.utils.custom_rest_exception_handler',
    'DEFAULT_PERMISSION_CLASSES': [
        'lastweekend_photos.helpers.utils.CustomDjangoModelPermissions'
    ],
    ...
    'DEFAULT_PAGINATION_CLASS': 'lastweekend_photos.helpers.utils.CustomPagination',
    'DEFAULT_FILTER_BACKENDS': ('rest_framework_filters.backends.DjangoFilterBackend',
                                'rest_framework.filters.SearchFilter',
                                'lastweekend_photos.helpers.utils.ExtendedOrderingFilterBackend'),
...
ROOT_URLCONF = 'lastweekend_photos.urls'

TEMPLATES = [
    {
        'BACKEND': 'django.template.backends.django.DjangoTemplates',
        'DIRS': [os.path.join(BASE_DIR, 'lastweekend_photos', 'templates')],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
            ...
            'libraries': {
                'util_tags': 'lastweekend_photos.templatetags.util_tags',
            }
        },
    },
]

WSGI_APPLICATION = 'lastweekend_photos.wsgi.application'
