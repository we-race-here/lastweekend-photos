...
def avatar_file_path_func(instance, filename):
    from wrh_photos.helpers.utils import get_random_upload_path
...
class Photo(models.Model):
    ...
    def save(self, *args, **kwargs):
        from wrh_photos.helpers.utils import resize_photo
        if not self.pk:
...
class PhotoAds(models.Model):
    ...
    def make_file_with_ads(self):
        from wrh_photos.helpers.utils import paste_logos
